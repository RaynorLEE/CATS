...
def main():
    ...
    for idx, batch in enumerate(tqdm(test_batches, desc="Processing batches")):
        ...
        for batch_idx, test_triple in enumerate(batch):
            ...
            ontology_prompt = ONTOLOGY_REASON_PROMPT.format(fewshot_triples=fewshot_triples_sentence, test_triple=data_manager.triple_to_sentence(test_triple))
        ...
        for batch_idx, test_triple in enumerate(batch):
            neighbor_triples = data_manager.neighbor_triple_finder(test_triple)
