...
SELECTING_PROMPT = """Please determine whether the input triple is consistent within the same ontological framework with a set of known triples in the knowledge graph, which means the entities are consistent in entity type.
