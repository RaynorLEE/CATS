...
# 文件路径
json_file_path = 'datasets/FB15k-237-subset-inductive/paths/close_path.json'
txt_file_path = 'datasets/FB15k-237-subset-inductive/test.txt'
...
# 绘制直方图
plt.figure(figsize=(5, 2))  # 修改此处的高度为2英寸
...
plt.savefig('path_count_bins_histogram.pdf', 
